...
class ticket:
    def __init__(self, root):
        ...
        self.TFrame=Label(TFrame, font=('Arial', 51, 'bold'), text="ONLINE TICKET MANAGEMENT SYSTEM", bg="#1e3d59", fg="#f5f0e1")
        self.TFrame.grid() 
        ...
        DFrameL=LabelFrame(DFrame, bd=2, width=1000, height=600, padx=20, bg="#1e3d59", relief=RIDGE, font=('Arial', 20, 'bold'), text="Discount Information\n", fg="#f5f0e1")
        DFrameL.pack(side=LEFT)

        DFrameR=LabelFrame(DFrame, bd=2, width=450, height=300, padx=31, pady=3, bg="#1e3d59", relief=RIDGE, font=('Arial', 20, 'bold'), text="Discount Details\n", fg="#f5f0e1")
        ...
        self.lbloffer_id=Label(DFrameL, font=('Arial', 18, 'bold'), text="Offer ID:", padx=2, pady=2, bg="#1e3d59", fg="#f5f0e1")
        self.lbloffer_id.grid(row=1, column=0, sticky=W) 
        self.txtoffer_id=Entry(DFrameL, font=('Arial', 18, 'bold'), textvariable=offer_id, width=39, bg="#1e3d59", fg="#f5f0e1")
