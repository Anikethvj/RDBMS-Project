...
class ticket:
    def __init__(self, root):
        ...
        self.TFrame=Label(TFrame, font=('Arial', 51, 'bold'), text="ONLINE ticket TICKET BOOKING SYSTEM", bg="#1e3d59", fg="#f5f0e1")
        self.TFrame.grid() 
        ...
        DFrameL=LabelFrame(DFrame, bd=2, width=1000, height=600, padx=20, bg="#1e3d59", relief=RIDGE, font=('Arial', 20, 'bold'), text="Ticket Information\n", fg="#f5f0e1")
        DFrameL.pack(side=LEFT)

        DFrameR=LabelFrame(DFrame, bd=2, width=450, height=300, padx=31, pady=3, bg="#1e3d59", relief=RIDGE, font=('Arial', 20, 'bold'), text="Ticket Details\n", fg="#f5f0e1")
        ...
        self.lblseat_id=Label(DFrameL, font=('Arial', 18, 'bold'), text="Seat ID:", padx=2, pady=2, bg="#1e3d59", fg="#f5f0e1")
        self.lblseat_id.grid(row=1, column=0, sticky=W) 
        self.txtseat_id=Entry(DFrameL, font=('Arial', 18, 'bold'), textvariable=seat_id, width=39, bg="#1e3d59", fg="#f5f0e1")
        self.txtseat_id.grid(row=1, column=1)

        self.lblmatch_no=Label(DFrameL, font=('Arial', 18, 'bold'), text="Match No:", padx=2, pady=2, bg="#1e3d59", fg="#f5f0e1")
        self.lblmatch_no.grid(row=2, column=0, sticky=W) 
        self.txtmatch_no=Entry(DFrameL, font=('Arial', 18, 'bold'), textvariable=match_no, width=39, bg="#1e3d59", fg="#f5f0e1")
        self.txtmatch_no.grid(row=2, column=1)

        self.lblmatch_no=Label(DFrameL, font=('Arial', 18, 'bold'), text="Match DateTime:", padx=2, pady=2, bg="#1e3d59", fg="#f5f0e1")
        self.lblmatch_no.grid(row=3, column=0, sticky=W) 
        self.txtmatch_no=Entry(DFrameL, font=('Arial', 18, 'bold'), textvariable=match_date_time, width=39, bg="#1e3d59", fg="#f5f0e1")
        self.txtmatch_no.grid(row=3, column=1)

        self.lblprice=Label(DFrameL, font=('Arial', 18, 'bold'), text="Price:", padx=2, pady=2, bg="#1e3d59", fg="#f5f0e1")
        self.lblprice.grid(row=4, column=0, sticky=W) 
        self.txtprice=Entry(DFrameL, font=('Arial', 18, 'bold'), textvariable=price, width=39, bg="#1e3d59", fg="#f5f0e1")
        self.txtprice.grid(row=4, column=1)

        self.lblveg=Label(DFrameL, font=('Arial', 18, 'bold'), text="Veg Ordered:", padx=2, pady=2, bg="#1e3d59", fg="#f5f0e1")
        self.lblveg.grid(row=5, column=0, sticky=W) 
        self.txtveg=Entry(DFrameL, font=('Arial', 18, 'bold'), textvariable=veg, width=39, bg="#1e3d59", fg="#f5f0e1")
        self.txtveg.grid(row=5, column=1)

        self.lblnonveg=Label(DFrameL, font=('Arial', 18, 'bold'), text="Nonveg Ordered:", padx=2, pady=2, bg="#1e3d59", fg="#f5f0e1")
        self.lblnonveg.grid(row=6, column=0, sticky=W) 
        self.txtnonveg=Entry(DFrameL, font=('Arial', 18, 'bold'), textvariable=nonveg, width=39, bg="#1e3d59", fg="#f5f0e1")
        self.txtnonveg.grid(row=6, column=1)

        self.lblnonveg=Label(DFrameL, font=('Arial', 18, 'bold'), text="Snacks Ordered:", padx=2, pady=2, bg="#1e3d59", fg="#f5f0e1")
        ...
        ticketList=Listbox(DFrameR, width=41, height=16, font=('Arial', 12, 'bold'), bg="#1e3d59", fg="#f5f0e1", yscrollcommand=sb.set)
