...
class match:
	def __init__(self, root):
		...
		self.lblhome=Label(DFrameL, font=('Arial', 18, 'bold'), text="home (y/n):", padx=2, pady=2, bg="#1e3d59", fg="#f5f0e1")
		self.lblhome.grid(row=5, column=0, sticky=W) 
		self.txthome=Entry(DFrameL, font=('Arial', 18, 'bold'), textvariable=home, width=39, bg="#1e3d59", fg="#f5f0e1")
		self.txthome.grid(row=5, column=1)

		self.lblaway=Label(DFrameL, font=('Arial', 18, 'bold'), text="away (y/n):", padx=2, pady=2, bg="#1e3d59", fg="#f5f0e1")
		self.lblaway.grid(row=6, column=0, sticky=W) 
		self.txtaway=Entry(DFrameL, font=('Arial', 18, 'bold'), textvariable=away, width=39, bg="#1e3d59", fg="#f5f0e1")
		self.txtaway.grid(row=6, column=1)

		self.lblduration=Label(DFrameL, font=('Arial', 18, 'bold'), text="duration", padx=2, pady=2, bg="#1e3d59", fg="#f5f0e1")
		self.lblduration.grid(row=7, column=0, sticky=W) 
		self.txtduration=Entry(DFrameL, font=('Arial', 18, 'bold'), textvariable=duration, width=39, bg="#1e3d59", fg="#f5f0e1")
